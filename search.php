...
<?php include 'parts/header.php' ?>
    <fieldset>
        ...
        <form method='get'>
            ...
            <p><label for='min_life_expectancy'>Lebenserwartung:</label><input type='number' id='min_life_expectancy' name='min_life_expectancy' <?php echo form_value($_GET, 'min_life_expectancy', 'text'); ?>> bis <input type="number" id="max_life_expectancy" name="max_life_expectancy" <?php echo form_value($_GET, 'max_life_expectancy', 'text'); ?>></p>
